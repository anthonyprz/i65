...
alter table anuncio add CHECK (fecha >= '01-01-2010');

alter table anuncio add CHECK (fecha < getdate());

ALTER TABLE anuncio
DROP CONSTRAINT CK__anuncio__fecha__48CFD27E

sp_helpconstraint anuncio
--CK__anuncio__fecha__48CFD27E
...
insert into anuncio (codigoAnuncio,texto,fecha,precio,codLocalidad,codCategoria,codigoSubCategoria,codigoUsuario,fotografia)
 ...
 values (13,'audi','10/01/2016',500.00,1,2,5,1,1)
  ...
  insert into anuncio (codigoAnuncio,texto,fecha,precio,codLocalidad,codCategoria,codigoSubCategoria,codigoUsuario,fotografia)
               values (17,'check date','20/01/2009',500.00,1,2,5,1,1)

			   insert into anuncio (codigoAnuncio,texto,fecha,precio,codLocalidad,codCategoria,codigoSubCategoria,codigoUsuario,fotografia)
               values (18,'check date','20/01/2019',500.00,1,2,5,1,1)
...
--ejecutar 
exec obetener_usuario 7; --codigo de anuncio para obtener el usuario 
